    ...
    <main>
        <div class="hero-container">
            <div class="hero-information">
                <h1 class="welcome-message">
                    The best, affordable packing space solution in London.
                </h1>
                    <p class="download-message">Download the SparePark app</p>
                <div class="ctd-container">
                    <div class="ctd-container__svg">
                        <svg width="135px" height="135px" viewBox="0 -47.5 135 135" id="Layer_1"
                    ...
                    <div class="ctd-container__svg">
                        <svg width="135px" height="135px" viewBox="0 -189.93 539.856 539.856"
                        xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="cta-container">
            <section class="cta__section">
                <h2 class="cta__main-text">Earn income off your parking space.</h2>
                <p class="cta__section-small-text">Enjoy the lowest commission and the fairest treatment.</p>
            </section>
            <section class="cta__section-button">
                <button class="owner_button">
                    Sign up your space
                </button>
            </section>
        </div>
        ...
        <div class="home-info">
            <section class="home-info__section about">
                <div class="home-info__image">
                    <?xml version="1.0" encoding="iso-8859-1"?>
                    <!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 502.643 502.643"
                        style="enable-background:new 0 0 502.643 502.643;" xml:space="preserve">
                        <g>
                            <g>
                ...
                <p class="home-info__body">
                    Find out how we started, what drives us, and how we’re reimagining how the world moves.
                    
                </p>
            </section>
            <section class="home-info__section">
                <div class="home-info__image">
                    <?xml version="1.0" encoding="iso-8859-1"?>
                    <!-- Generator: Adobe Illustrator 18.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                    <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 283.358 283.358"
                        style="enable-background:new 0 0 283.358 283.358;" xml:space="preserve">
                        <g>
                ...
                <p class="home-info__body">
                    Are you a home owner in London? Do you know you can make money from your home packing space?
                    Sign up as a home owner to know more
                </p>
            ...
            <section class="home-info__section">
                ...
                <p class="home-info__body">
                    Are you a driver in London?Are you tired of parking tickets and expensive parking lots?
            ...
            <section class="feature">
                <div class="feature_image">
                    ...
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                        style="enable-background:new 0 0 512 512;" xml:space="preserve">
                        <path style="fill:#F3D49D;"
                            d="M451.177,256.355L245.792,122.63l-63.871-31.174l-93.589-22.51L0,251.31l47.208,40.632
                        ...
                        <g>
                            <path style="fill:#A67420;"
                                d="M215.539,352.459L215.539,352.459c-16.164-10.445-37.734-5.808-48.179,10.356
                            ...
                            <path style="fill:#A67420;"
                                d="M245.792,122.63l-46.631,70.773c-10.445,16.164-32.014,20.801-48.178,10.356l0,0
                        ...
                        <g>
                            ...
                            <polygon style="fill:#7A5007;"
                                points="315.727,168.164 440.013,249.087 512,195.78 485.208,105.484 	" />
                        </g>
                        <g>
                        </g>
                        <g>
                ...
                <h3 class="feature-title">No where to Park?</h3>
                <p class="feature-body">Get a convenient spot with SparePark.</p>
            </section>
            <section class="feature">
                <div class="feature_image">
                    <?xml version="1.0" encoding="iso-8859-1"?>
                    ...
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g>
                            ...
                            <path style="fill:#D6A35F;"
                                d="M3,5v47.783C3,54.56,4.44,56,6.217,56h33.566C41.56,56,43,54.56,43,52.783V5H3z" />
                            ...
                            <path style="fill:#AD8049;"
                                d="M35,35c-0.553,0-1-0.447-1-1v-9c0-0.553,0.447-1,1-1s1,0.447,1,1v9C36,34.553,35.553,35,35,35z" />
                            <path style="fill:#AD8049;"
                                d="M35,48c-0.553,0-1-0.447-1-1v-9c0-0.553,0.447-1,1-1s1,0.447,1,1v9C36,47.553,35.553,48,35,48z" />
                            <path style="fill:#AD8049;"
                                d="M30,27c-0.553,0-1-0.447-1-1v-1c0-0.553,0.447-1,1-1s1,0.447,1,1v1C31,26.553,30.553,27,30,27z" />
                            <path style="fill:#AD8049;"
                                d="M30,33c-0.553,0-1-0.447-1-1v-2c0-0.553,0.447-1,1-1s1,0.447,1,1v2C31,32.553,30.553,33,30,33z" />
                            <path style="fill:#AD8049;"
                                d="M30,38c-0.553,0-1-0.447-1-1v-1c0-0.553,0.447-1,1-1s1,0.447,1,1v1C31,37.553,30.553,38,30,38z" />
                            <path style="fill:#AD8049;"
                                d="M30,44c-0.553,0-1-0.447-1-1v-2c0-0.553,0.447-1,1-1s1,0.447,1,1v2C31,43.553,30.553,44,30,44z" />
                            <path style="fill:#AD8049;"
                                d="M30,48c-0.26,0-0.521-0.11-0.71-0.29C29.109,47.52,29,47.26,29,47s0.109-0.521,0.29-0.71
                            ...
                            <g>
                                <path style="fill:#F0C419;"
                                    d="M26,6v12.745C26,19.438,26.562,20,27.255,20h9.49C37.438,20,38,19.438,38,18.745V6H26z" />
                            ...
                            <path style="fill:#ED7161;"
                                d="M52,57c-0.256,0-0.512-0.098-0.707-0.293c-0.391-0.391-0.391-1.023,0-1.414l6-6
                            ...
                            <path style="fill:#ED7161;"
                                d="M52,57c-0.553,0-1-0.447-1-1V28c0-0.553,0.447-1,1-1s1,0.447,1,1v28C53,56.553,52.553,57,52,57z" />
                            <g>
                            ...
                            <g>
                                ...
                                <path style="fill:#F3D55B;"
                                    d="M30,21c-0.553,0-1-0.447-1-1v-6c0-0.553,0.447-1,1-1s1,0.447,1,1v6C31,20.553,30.553,21,30,21z" />
                            </g>
                            <g>
                                <line style="fill:#F0C419;" x1="34" y1="10" x2="34" y2="6" />
                                <path style="fill:#F3D55B;"
                                    d="M34,11c-0.553,0-1-0.447-1-1V6c0-0.553,0.447-1,1-1s1,0.447,1,1v4C35,10.553,34.553,11,34,11z" />
                            </g>
                            <g>
                                <line style="fill:#F0C419;" x1="30" y1="10" x2="30" y2="6" />
                                <path style="fill:#F3D55B;"
                                    d="M30,11c-0.553,0-1-0.447-1-1V6c0-0.553,0.447-1,1-1s1,0.447,1,1v4C31,10.553,30.553,11,30,11z" />
                            </g>
                        </g>
                        <g>
                        </g>
                ...
                <h3 class="feature-title">The lowest rate</h3>
                <p class="feature-body">We aim to offer the best and close parking spots in London.Give us a try!</p>
            </section>
            <section class="feature">
                <div class="feature_image">
                    <?xml version="1.0" encoding="iso-8859-1"?>
                ...
                <p class="feature-body">We guarantee you a safe parking spots while you go about your business.</p>
            </section>
        </div>
        ...
        <div class="final-cta">
            <div class="block-container">
                <h2 class="block-title">Get SparePark now</h2>
                ...
                <p class="owner-signup">Or <a href="#">sign up</a> as an owner</p>
            </div>
        </div>
